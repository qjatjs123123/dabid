    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          <p className="bg-gray-100 p-2 rounded-lg">이름이 왜 비드미야?</p>
          <p className="bg-gray-100 p-2 rounded-lg">입찰을 취소하고 싶어.</p>
          <p className="bg-gray-100 p-2 rounded-lg">낙찰되지 않은 경매는 어떻게 돼?</p>
          <p className="bg-gray-100 p-2 rounded-lg">보증금은 언제 환급받을 수 있어?</p>
          <p className="bg-gray-100 p-2 rounded-lg">다비드는 어떤 서비스야?</p>
          <p className="bg-gray-100 p-2 rounded-lg">경매는 어떤 방식으로 진행해?</p>
          <p className="bg-gray-100 p-2 rounded-lg">고객센터</p>
        </div>
        <p className="text-gray-600 mt-4">다비드에 대해 궁금한 점은 무엇이든 물어보세요!</p>
