  ...
  useEffect(() => {
    const fetchAuctions = async () => {
      try {
        ...
        const accessToken =
          'eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6ImE1MDVkc2Fzc2FmeTIzNTFhZHNhQHNzYWZ5ZHNhZHNhLmNvbSIsImlhdCI6MTcyNzY1OTA1NCwiZXhwIjoxNzI3NjY5ODU0fQ.CycIi0oNRGubudvG5gMtyNeoWKtb7ctjQxIE4MAwmKM'; //localStorage.getItem('accessToken');
