...
//   const borderColorClasses = isActive ? 'border-[rgba(242,170,103,1.0)] border-2' : 'border-[rgba(0,0,0,0.1)] border-2';

//   const transitionClasses = 'duration-100';

//   return { boxShadowClasses, borderColorClasses, transitionClasses };
// };
